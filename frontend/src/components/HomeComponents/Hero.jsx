  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        <h1 className="text-xl md:text-2xl lg:text-2xl font-bold leading-tight pt-10 lg:pt-50">
          cirmatch.com
          <br />
          <br />
          <span className="text-teal-500 relative inline-block">
            একটি অনলাইন মার্কেটপ্লেস যেখানে যাবতীয় প্লাস্টিক রিসাইক্লিং
            প্রোডাক্ট (যেমন : বোতল, কুঁচি, দানা,....) কেনাবেচা করা যায়।
          </span>{" "}
        </h1>

        {/* Description Paragraph */}
        <p className="text-gray-600 text-lg md:text-xl max-w-xl">
          বাংলাদেশের সবচেয়ে বেশী buyer এবং seller আছে cirmatch.com এর
          মার্কেটপ্লেসে । তাই, এক জায়গায় রিসাইক্লিং প্লাস্টিকের সব টাইপের
          Product Or Materials কেনাবেচা করুন cirmatch এর Verified Buyer and
          Seller এর সাথে।
          <br />
          <br />
