  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 text-lg mb-6">
        <p>
          <span className="font-semibold">Plastic Type:</span>{" "}
          {listing.plastictype}
        </p>
        <p>
          <span className="font-semibold">Metarial Type:</span>{" "}
          {listing.metarialtype}
        </p>
        <p>
          <span className="font-semibold">Quantity:</span> {listing.quantity}
        </p>
        {listing.sourcingCondition != null && (
          <p>
            <span className="font-semibold">Sourcing Condition:</span>{" "}
            {listing.sourcingCondition}
          </p>
        )}
        {listing.washingProcess != null && (
          <p>
            <span className="font-semibold">Washing Process:</span>{" "}
